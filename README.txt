...
##Note:
- Using AspNetCore with existing database: PM> Scaffold-DbContext "Server=DESKTOP-V1I9QML\SQLEXPRESS;Database=VisingPackMMS;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer
- In VisingPackSolution.Data: do not use Entity.Framework
- Primary Key
- In VisingPackSolution.Data: "OnModelCreatingModel" func -> add this "base.OnModelCreating(modelBuilder);"
- Database: because of IdentityUser, change name to App to AspNet 
...
using System;
using VisingPackSolution.ApiIntegration;
...
namespace VisingPackSolution.AdminApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IWorkTimeManageApiClient, WorkTimeManageApiClient>();
            services.AddTransient<IProductionTrackingApiClient, ProductionTrackingApiClient>();

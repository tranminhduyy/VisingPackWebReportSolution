...
namespace VisingPackSolution.AdminApp.Controllers
{
    ...
    public class MsGluingController : BaseController
    {
        private readonly IMachineStateApiClient _msApiClient;
        private readonly IConfiguration _configuration;
        public MsGluingController(IMachineStateApiClient msApiClient,
        ...
        public async Task<IActionResult> Index(DateTime from, DateTime to)
        {
            ...
            var data = await _msApiClient.GetMsGluingByTime(request);

            ViewBag.D650SpeedDataPoints = JsonConvert.SerializeObject(data.D650Speeds, _jsonSetting);
            ViewBag.D750SpeedDataPoints = JsonConvert.SerializeObject(data.D750Speeds, _jsonSetting);
            ViewBag.D1000SpeedDataPoints = JsonConvert.SerializeObject(data.D1000Speeds, _jsonSetting);
            ViewBag.D1100SpeedDataPoints = JsonConvert.SerializeObject(data.D1100Speeds, _jsonSetting);
            ...
            return View("~/Views/MachineState/Gluing.cshtml", data);
        }
        ...
        public async Task<IActionResult> GetDataLastHour()
        {
            ...
            return View("~/Views/MachineState/Gluing.cshtml", result);
        }
        ...
        private async Task<MsGluingVM> GetData(GetMsByTimeRequest request)
        {
            var data = await _msApiClient.GetMsGluingByTime(request);
